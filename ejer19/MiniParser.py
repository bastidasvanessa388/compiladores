...
def serializedATN():
    return [
        ...
        0,0,9,10,1,0,0,0,10,1,1,0,0,0,11,12,5,4,0,0,12,13,5,2,0,0,13,17,
        3,4,2,0,14,15,5,1,0,0,15,17,3,4,2,0,16,11,1,0,0,0,16,14,1,0,0,0,
...
class MiniParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "PRINT", "IGUAL", "MAS", "ID", "NUM", 
                      "WS" ]
