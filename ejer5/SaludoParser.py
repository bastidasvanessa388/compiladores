...
def serializedATN():
    return [
        4,1,3,9,2,0,7,0,1,0,1,0,4,0,5,8,0,11,0,12,0,6,1,0,0,0,1,0,0,0,8,
        0,4,1,0,0,0,2,3,5,1,0,0,3,5,5,2,0,0,4,2,1,0,0,0,5,6,1,0,0,0,6,4,
        1,0,0,0,6,7,1,0,0,0,7,1,1,0,0,0,1,6
    ]
...
class SaludoParser ( Parser ):
    ...
    class SaludoContext(ParserRuleContext):
        ...
        def NOMBRE(self, i:int=None):
            if i is None:
                return self.getTokens(SaludoParser.NOMBRE)
            else:
                return self.getToken(SaludoParser.NOMBRE, i)
