...
class PrintListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PrintParser#prog.
    def enterProg(self, ctx:PrintParser.ProgContext):
        pass

    # Exit a parse tree produced by PrintParser#prog.
    def exitProg(self, ctx:PrintParser.ProgContext):
        pass
