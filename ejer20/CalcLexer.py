...
def serializedATN():
    return [
        ...
        44,1,0,0,0,19,49,1,0,0,0,21,54,1,0,0,0,23,24,5,112,0,0,24,25,5,114,
        0,0,25,26,5,105,0,0,26,27,5,110,0,0,27,28,5,116,0,0,28,2,1,0,0,0,
        29,30,5,61,0,0,30,4,1,0,0,0,31,32,5,43,0,0,32,6,1,0,0,0,33,34,5,
        45,0,0,34,8,1,0,0,0,35,36,5,42,0,0,36,10,1,0,0,0,37,38,5,47,0,0,
...
class CalcLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "PRINT", "IGUAL", "MAS", "MENOS", "MUL", "DIV", "PARI", "PARD", 
            "ID", "NUM", "WS" ]

    ruleNames = [ "PRINT", "IGUAL", "MAS", "MENOS", "MUL", "DIV", "PARI", 
                  "PARD", "ID", "NUM", "WS" ]
