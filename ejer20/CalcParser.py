...
def serializedATN():
    return [
        ...
        13,14,1,0,0,0,14,1,1,0,0,0,15,16,5,9,0,0,16,17,5,2,0,0,17,21,3,4,
        2,0,18,19,5,1,0,0,19,21,3,4,2,0,20,15,1,0,0,0,20,18,1,0,0,0,21,3,
...
class CalcParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "PRINT", "IGUAL", "MAS", "MENOS", "MUL", 
                      "DIV", "PARI", "PARD", "ID", "NUM", "WS" ]
    ...
    class FactorContext(ParserRuleContext):
        ...
        def PARI(self):
            return self.getToken(CalcParser.PARI, 0)
        ...
        def PARD(self):
            return self.getToken(CalcParser.PARD, 0)
    ...
    def factor(self):
        ...
        try:
            ...
            if token in [10]:
                ...
                self.state = 40
                self.match(CalcParser.PARI)
                self.state = 41
                self.expr()
                self.state = 42
                self.match(CalcParser.PARD)
                pass
            else:
                raise NoViableAltException(self)
